...
import dao.IThongKeDoanhThuDAO;
import db.JPAUtil;
...
public class ThongKeDoanhThuDAO extends BaseDAO implements IThongKeDoanhThuDAO {

    private static final Logger LOGGER = Logger.getLogger(ThongKeDoanhThuDAO.class.getName());
    ...
    private static final String COL_HD_TONG_TIEN = "tongTien";
    ...
    public Map<String, ThongKeChiTietItem> getThongKeDoanhThuChiTiet(
        ...
        String sql = buildBaseCTE(loaiTuyen, nhanVienID, isTienMat) +
                "SELECT " +
    ...
    public int getTongHoaDonBan(LocalDate tuNgay, LocalDate denNgay,
        ...
        String sql = buildBaseCTE(loaiTuyen, nhanVienID, isTienMat) +
                ...
                "WHERE b.hoaDonID NOT LIKE 'HDHV%' AND b.hoaDonID NOT LIKE 'HDDV%'";
    ...
    public int getTongHoaDonHoanDoi(LocalDate tuNgay, LocalDate denNgay,
        ...
        String sql = buildBaseCTE(loaiTuyen, nhanVienID, isTienMat) +
                "SELECT COUNT(*) AS Cnt FROM Base b " +
                "WHERE b.hoaDonID LIKE 'HDHV%' OR b.hoaDonID LIKE 'HDDV%'";
    ...
    public double getTongThuDichVu(LocalDate tuNgay, LocalDate denNgay,
                                   ...
                                   String nhanVienID, Integer isTienMat) throws SQLException {
        String sql = buildBaseCTE(loaiTuyen, nhanVienID, isTienMat) +
                "SELECT ISNULL(SUM(b.thuDichVu), 0) AS Tong FROM Base b";
