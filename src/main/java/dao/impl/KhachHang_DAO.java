...
public class KhachHang_DAO {
    ...
    public boolean themKhachHang(KhachHang kh) {
        ...
        try (Connection con = connectDB.getConnection(); PreparedStatement pstmt = con.prepareStatement(sql)) {
            ...
            pstmt.setString(7, kh.getLoaiDoiTuong() != null ? kh.getLoaiDoiTuong().getLoaiDoiTuongID() : null);
            pstmt.setString(8, kh.getLoaiKhachHang() != null ? kh.getLoaiKhachHang().getLoaiKhachHangID() : null);
    ...
    public boolean capNhatKhachHang(KhachHang kh) {
        ...
        try (Connection con = connectDB.getConnection(); PreparedStatement pstmt = con.prepareStatement(sql)) {
            ...
            pstmt.setString(6, kh.getLoaiDoiTuong() != null ? kh.getLoaiDoiTuong().getLoaiDoiTuongID() : null);
            pstmt.setString(7, kh.getLoaiKhachHang() != null ? kh.getLoaiKhachHang().getLoaiKhachHangID() : null);
    ...
    private KhachHang taoKhachHangTuResultSet(ResultSet rs) throws SQLException {
        ...
        try {
            ...
            if (loaiDoiTuongStr != null) {
                loaiDT = new LoaiDoiTuong(loaiDoiTuongStr);
            }
            if (loaiKhachHangStr != null) {
                loaiKH = new LoaiKhachHang(loaiKhachHangStr);
            }
    ...
    public boolean saveOrUpdate(Connection conn, KhachHang khachHang) throws Exception {
        ...
        try (PreparedStatement pstmt = conn.prepareStatement(sql)) {
            ...
            pstmt.setString(7, khachHang.getLoaiDoiTuong() != null ? khachHang.getLoaiDoiTuong().getLoaiDoiTuongID() : null);
            pstmt.setString(8, khachHang.getLoaiKhachHang() != null ? khachHang.getLoaiKhachHang().getLoaiKhachHangID() : null);
