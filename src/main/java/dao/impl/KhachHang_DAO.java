...
public class KhachHang_DAO {
    ...
    public boolean themKhachHang(KhachHang kh) {
        ...
        try (Connection con = connectDB.getConnection(); PreparedStatement pstmt = con.prepareStatement(sql)) {
            ...
            pstmt.setString(7, kh.getLoaiDoiTuong() != null ? kh.getLoaiDoiTuong().getMoTa() : null);
            pstmt.setString(8, kh.getLoaiKhachHang() != null ? kh.getLoaiKhachHang().getMoTa() : null);
    ...
    public boolean capNhatKhachHang(KhachHang kh) {
        ...
        try (Connection con = connectDB.getConnection(); PreparedStatement pstmt = con.prepareStatement(sql)) {
            ...
            pstmt.setString(6, kh.getLoaiDoiTuong() != null ? kh.getLoaiDoiTuong().getMoTa() : null);
            pstmt.setString(7, kh.getLoaiKhachHang() != null ? kh.getLoaiKhachHang().getMoTa() : null);
            pstmt.setString(8, kh.getId());
    ...
    public boolean capNhatLoaiKhachHang(KhachHang khachHang) {
        ...
        try (Connection con = connectDB.getConnection(); PreparedStatement pstmt = con.prepareStatement(sql)) {
            ...
            pstmt.setString(2, khachHang.getId());
    ...
    private KhachHang taoKhachHangTuResultSet(ResultSet rs) throws SQLException {
        ...
        return new KhachHang(id, hoTen, sdt, email, soGiayTo, diaChi, entity.LoaiDoiTuong.builder().id(loaiDoiTuongStr).build(), LoaiKhachHang.builder().id(loaiKhachHangStr).build());
    }
    ...
    public boolean saveOrUpdate(Connection conn, KhachHang khachHang) throws Exception {
        ...
        try (PreparedStatement pstmt = conn.prepareStatement(sql)) {
            ...
            pstmt.setString(1, khachHang.getId());
            ...
            pstmt.setString(7, khachHang.getLoaiDoiTuong() != null ? khachHang.getLoaiDoiTuong().getMoTa() : null);
            pstmt.setString(8, khachHang.getLoaiKhachHang() != null ? khachHang.getLoaiKhachHang().getMoTa() : null);
