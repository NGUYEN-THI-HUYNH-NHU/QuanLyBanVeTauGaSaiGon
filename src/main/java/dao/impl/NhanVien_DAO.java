...
public class NhanVien_DAO {
    ...
    public List<NhanVien> getNhanVienVoiHoTen(String hoTenTim) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                VaiTroNhanVien vaiTroNhanVien = new VaiTroNhanVien(resultSet.getString(2));
        ...
        try (PreparedStatement stmt = connection.prepareStatement(sql.toString())) {
            ...
            while (rs.next()) {
                NhanVien nv = new NhanVien(rs.getString("nhanVienID"),
                        new VaiTroNhanVien(rs.getString("vaiTroNhanVienID")), rs.getString("hoTen"),
    ...
    public VaiTroNhanVienEnums layVaiTroNhanVienTheoMaNV(String maNV) {
        ...
        try (Connection con = connectDB.getConnection(); PreparedStatement ps = con.prepareStatement(sql)) {
            ...
            ResultSet rs = ps.executeQuery();
            if (rs.next()) {
                return VaiTroNhanVienEnums.valueOf(rs.getString("vaiTroNhanVienID"));
            }
        } catch (SQLException e) {
            e.printStackTrace();
        }
    ...
    private NhanVien mapResultSetToNhanVien(ResultSet rs) throws SQLException {
        ...
        VaiTroNhanVien vaiTro = new VaiTroNhanVien(rs.getString("vaiTroNhanVienID"));
    ...
    public boolean themNhanVien(NhanVien nv) {
        ...
        try (Connection con = connectDB.getConnection(); PreparedStatement ps = con.prepareStatement(sql)) {
            ...
            ps.setDate(5, Date.valueOf(nv.getNgaySinh()));
            ps.setString(6, nv.getSoDienThoai());
            ps.setString(7, nv.getEmail());
            ps.setString(8, nv.getDiaChi());
            ps.setDate(9, Date.valueOf(nv.getNgayThamGia()));
