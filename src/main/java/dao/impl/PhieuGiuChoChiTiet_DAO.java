...
public class PhieuGiuChoChiTiet_DAO {
    ...
    public boolean checkConflict(Connection conn, String chuyenID, String tenGaDi, String tenGaDen, int soToa,
        ...
        try (PreparedStatement ps = conn.prepareStatement(sqlCheck)) {
            ...
            ps.setString(2, tenGaDi);
            ps.setString(3, tenGaDen);
            ps.setInt(4, soToa);
            ps.setInt(5, soGhe);
            ps.setInt(6, HOLD_DURATION_MINUTES);
            ...
            e.printStackTrace();
            // Nếu có lỗi SQL (ví dụ: RAISEERROR), coi như là có xung đột để đảm bảo an toàn
            return true;
        }
    }
     ...
     * @return
     */
    public boolean deletePhieuGiuChoChiTietByPgcID(Connection conn, String phieuGiuChoID) {
