...
public class ModalChiTietDonDatCho extends JDialog {
    private final DonDatChoDTO donDatCho;
    private final List<VeDTO> listVe;
    private final Font fontBold = new Font(getFont().getFontName(), Font.BOLD, 12);

    public ModalChiTietDonDatCho(Frame parent, DonDatChoDTO donDatCho, List<VeDTO> listVe) {
        super(parent, "Chi Tiết Đơn Đặt Chỗ: " + donDatCho.getId(), true);
    ...
    private JPanel createHeader() {
        ...
        pnlSub.add(new JLabel("Mã đơn: " + donDatCho.getId()));
    ...
    private JPanel createBody() {
        ...
        pnlInfo.add(createLabelInfo("Họ tên:", donDatCho.getKhachHangDTO().getHoTen()));
        pnlInfo.add(createLabelInfo("Số giấy tờ:", donDatCho.getKhachHangDTO().getSoGiayTo()));
        pnlInfo.add(createLabelInfo("Số điện thoại:", donDatCho.getKhachHangDTO().getSoDienThoai()));
        pnlInfo.add(createLabelInfo("Email:", donDatCho.getKhachHangDTO().getEmail()));
    ...
    private JPanel createFooter() {
        ...
        // Tính tổng tiền
        double total = listVe.stream().mapToDouble(VeDTO::getGia).sum();
