...
public class ModalHoaDon extends JDialog {
    ...
    private final List<HoaDonChiTietDTO> listChiTiet;
    ...
    public ModalHoaDon(Frame parent, HoaDonDTO hoaDon, List<HoaDonChiTietDTO> listChiTiet) {
        super(parent, "Xem Hóa Đơn: " + hoaDon.getId(), true);
        this.hoaDon = hoaDon;
    ...
    private JPanel createHeader() {
        ...
        if (hoaDon.getId().startsWith("HDDV")) {
            lblTitle = new JLabel("HÓA ĐƠN ĐỔI VÉ");
        } else if (hoaDon.getId().startsWith("HDHV")) {
        ...
        pRight.add(createRightAlignLabel("Số: " + hoaDon.getId()));
    ...
    private JPanel createFooter() {
        ...
        JLabel lblWeb = new JLabel(
                "Tra cứu tại website: https://hoadon.vtdsvn.vn - Mã tra cứu: " + hoaDon.getId());
