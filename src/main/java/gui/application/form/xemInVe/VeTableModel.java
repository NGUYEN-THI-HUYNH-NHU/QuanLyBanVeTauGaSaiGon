...
public class VeTableModel extends AbstractTableModel {
	...
	private Consumer<Ve> rowSelectionListener;

	public VeTableModel() {
		this.rows = new ArrayList<>();
	}

	public void setRows(List<Ve> rows) {
		this.rows = new ArrayList<>(rows);
		fireTableDataChanged(); // Thông báo cho JTable cập nhật
	}

	public List<Ve> getRows() {
		return rows;
	}
	...
	public void setRowSelectionListener(Consumer<Ve> listener) {
		this.rowSelectionListener = listener;
	}

	public int getRowIndex(Ve rowToFind) {
		return rows.indexOf(rowToFind);
	}

	public Ve getRow(int rowIndex) {
