...
public class MenuCon extends JPanel {
    ...
    public MenuCon(ComponentOrientation orientation, Menu menu, int menuIndex, String menus[]) {
        this.menu = menu;
    ...
    private void init() {
        ...
        for (int i = 1; i < menus.length; i++) {
            ...
            button.addActionListener((ActionEvent e) -> {
                System.out.println("👉 Click submenu: " + menus[subIndex]);
                if (listener != null) listener.accept(subIndex);
                else {
                    System.out.println("⚙️ Gọi menu.runEvent(" + menuIndex + ", " + subIndex + ")");
    ...
    public void addMenuListener(IntConsumer listener) {
