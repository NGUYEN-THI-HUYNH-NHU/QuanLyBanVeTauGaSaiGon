...
public class Menu extends JPanel {
    ...
    public Menu(String role) {
    	...
    	putClientProperty(FlatClientProperties.STYLE, "" + "border:20,2,2,2;" + "background:$Menu.background;" + "arc:10");
        init(role);
    }
    ...
    private void init(String role) {
        ...
        vscroll.putClientProperty(FlatClientProperties.STYLE, "" + "width:$Menu.scroll.width;" + "trackInsets:$Menu.scroll.trackInsets;"
