...
public class PanelChuyenTau extends JPanel {
	...
	private JPanel createChuyenCard(Chuyen c, Consumer<Chuyen> onSelect) {
	    ...
	    JLabel lblNgayGioDi = new JLabel(String.format("TG đi %s", c.getGioDi().toString()),  SwingConstants.CENTER);
	    JLabel lblNgayGioDen = new JLabel(String.format("TG đến %s", c.getGioDen().toString()), SwingConstants.CENTER);
