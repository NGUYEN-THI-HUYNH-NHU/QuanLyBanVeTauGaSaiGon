...
/**
 * DAO thống kê cuối ca làm việc của nhân viên.
 * ĐÃ FIX:
 *  - TIME vs DATETIME (dùng LocalDateTime + Timestamp)
 *  - Đổi hinhThucThanhToan -> isThanhToanTienMat
...
public class ThongKeNhanVien_DAO {
    ...
    // ================================
    public int getTongSoHoaDonBanDuoc(String maNhanVien,
                                      LocalDate ngayLamViec,
                                      LocalTime gioBatDauCa,
        ...
        String sql =
                "SELECT COUNT(hoaDonID) FROM HoaDon " +
                        "WHERE nhanVienID = ? " +
                        "AND thoiDiemTao >= ? " +
                        "AND thoiDiemTao <= ? " +
                        "AND trangThai = 1";  // Hoàn thành = 1
    ...
    // ================================
    public int getTongSoHoaDonDoiTra(String maNhanVien,
                                     LocalDate ngayLamViec,
                                     LocalTime gioBatDauCa,
                                     LocalTime gioKetThucCa) {
    ...
    // ================================
    public int getTongSoVeBanDuoc(String maNhanVien,
                                  LocalDate ngayLamViec,
                                  LocalTime gioBatDauCa,
                                  LocalTime gioKetThucCa) {
        ...
        String sql =
                "SELECT COUNT(cthd.veID) FROM HoaDonChiTiet cthd " +
    ...
    // ================================
    public double getTongTienChuyenKhoan(String maNhanVien,
                                         LocalDate ngayLamViec,
                                         LocalTime gioBatDauCa,
                                         LocalTime gioKetThucCa) {
        ...
        String sql =
                "SELECT SUM(tongTien) FROM HoaDon " +
                        ...
                        "AND thoiDiemTao >= ? " +
                        "AND thoiDiemTao <= ? " +
                        "AND isThanhToanTienMat = 0 " +   // CHUYỂN KHOẢN
                        "AND trangThai = 1";
    ...
    // ================================
    public double getTongTienMat(String maNhanVien,
                                 LocalDate ngayLamViec,
                                 LocalTime gioBatDauCa,
                                 LocalTime gioKetThucCa) {
        ...
        String sql =
                "SELECT SUM(tongTien) FROM HoaDon " +
                        ...
                        "AND thoiDiemTao >= ? " +
                        "AND thoiDiemTao <= ? " +
                        "AND isThanhToanTienMat = 1 " +   // TIỀN MẶT
                        "AND trangThai = 1";
